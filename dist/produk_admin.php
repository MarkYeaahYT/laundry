...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
                        ...
                        <div class="modal-body">
                                ...
                                <div class="form-group">
                                    <div class="col-md-9">
                                        ...
                                        <input type="text" class="form-control" id="nama_e">
                                ...
                                <div class="form-group">
                                    <div class="col-md-9">
                                        ...
                                        <input type="number" class="form-control" id="harga_e">
                                        <small class="form-text text-muted"></small>
                                    </div>
                                </div>
        ...
        <!-- Own Script -->
        <script src="myjs/produk_admin.js"></script>
        <script>
            var mytable;
            $(document).ready(function () {
                    ...
                    ajax: {
                        url: url+'/laundry/dist/core.php?page=produk&action=r',
                        dataSrc: '',
                    },
                    columns: [
                        {data: 'nama'},
                        ...
                        {render: function (data, type, row) {
                            return "Rp "+parseInt(row.harga).toLocaleString();
                        }},
                        {render: function (data, type, row) {
